# Welcome to the Personalized Cold Email Generator by Lyzr!

![Lyzr Logo](./logo/lyzr-logo.png)

Struggling with generic cold emails? This AI tool personalizes subject lines, greetings, and content based on your prospect and product, boosting response rates, this app utilized lyzr generator agent to create personalized email for the prospect.
